        ...
        <div className="space-y-4">
          ...
          <Field label="Logo" hint="Square PNG or SVG works best.">
            <div className="flex items-center gap-3">
              {logo ? <img src={logo} alt="School logo" className="h-12 w-12 rounded-lg border border-ink-200 object-contain" /> : <span className="grid h-12 w-12 place-items-center rounded-lg bg-ink-100 text-xs text-ink-700">none</span>}
