...
const body = ["20260901000740_web_screens.sql", "20260901000750_operations.sql", "20260901000760_scale.sql",
              "20260901000770_screen_channel_join.sql", "20260901000780_anti_gaming_consent.sql"].map(read).join("\n");
...
// Follow-up for databases that already ran the 2026-09-24 release (0770 + 0780, both safe to re-run).
const followHeader = `-- =============================================================================
-- SwiftCipher update 2026-09-25: live screens over Realtime, anti-gaming,
-- parental monitoring consent.
